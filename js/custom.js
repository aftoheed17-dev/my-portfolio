      ...
      if ($form.length) {
        $form.validate({
          ...
          errorPlacement: function (error, element) {
            // This puts the error BELOW the input so it doesn't mess up the floating label
          ...
          submitHandler: function (form) {
            ...
            // Simulate sending (remove timeout and add your AJAX here)
            setTimeout(function () {
              $('#success').slideDown();
